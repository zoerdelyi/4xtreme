...
<div class="modal-body" id="modal-gallery" style="height:60vh;overflow-y:auto">
    <div class="row">
        <?php
        ...
        foreach ($images as $image) {
            ...
            <div id="image_<?php echo $i ?>" class="col-lg-3 col-md-3 col-sm-4">
                ...
                <div style="margin:-10px 0 14px 0" class="pull-right">
                    ...
                    &nbsp;&nbsp;<a data-toggle="tooltip" class="insert-image" data-image="<?php echo $image ?>" title="Kép lecserélése" href="javascript:;"><i class="fa fa-sign-in fa-lg"></i></a>
                </div>
            </div>
            <?php
            $i++;
