...
class BookingsCarsVisitorsController extends Controller
{
    ...
    public function update_calendar(Request $request){
        ...
        global $left_times_start;
        global $left_times_end;
        $OpeningHoursCars = OpeningHoursCars::all();
        $left_times_start = $OpeningHoursCars->min('start');
        $left_times_end = $OpeningHoursCars->max('end');
