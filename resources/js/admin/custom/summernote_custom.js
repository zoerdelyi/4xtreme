  ...
  var Editor = /** @class */ (function () {
      function Editor(context) {
          ...
          this.removeMedia = this.wrapCommand(function () {
            that_img = _this;
            that_img_html = that_img.restoreTarget();

            $.ajax({
                url: "/adminset/ajax/summernote/filemanager.php",
                dataType: "html",
...
// # # # # # # # # # # # # # # # # # # További egyéni fejlesztések: # # # # # # # # # # # # # # # # # #

// Popup ikonok eltűntetése lapozás esetén!
$('.main-panel').on('scroll',function() {
    $('.note-popover').hide();
});

// Forráskód megnyitása esetén teljes képernyőben történjen!
// $(document).on("click", ".btn-codeview", function() {
//     if( !($(this).parent('.note-view').find('.btn-fullscreen').hasClass('active')) || !($(this).parent('.note-view').find('.btn-codeview').hasClass('active')) ){
//         $(this).parent('.note-view').find('.btn-fullscreen').click();
//         $(this).closest('.note-editor').find('.CodeMirror').height($(window).height());
//         $(this).closest('.note-editor').find('.CodeMirror-vscrollbar').show();
//     }
// });
...
// Forráskód megnyitása esetén teljes képernyőben történjen!
var once_click = 0;
$(document).on("click", ".btn-codeview", function(e) {
    if( !($(this).parent('.note-view').find('.btn-fullscreen').hasClass('active')) || !($(this).parent('.note-view').find('.btn-codeview').hasClass('active')) ){
        if(once_click == 0){
            once_click = 1;
            $(this).parent('.note-view').find('.btn-codeview').click();
            $(this).parent('.note-view').find('.btn-fullscreen').click();
            $(this).parent('.note-view').find('.btn-codeview').click();
            setTimeout(function(){
                once_click = 0;
...
// # # # # # # # # # # # # # # # # # # További egyéni fejlesztések EDDIG # # # # # # # # # # # # # # #
