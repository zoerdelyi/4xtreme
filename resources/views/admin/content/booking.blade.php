        ...
        <table class="table filter_table">
            <thead>
                ...
                <tr>
                    ...
                    {{-- <th scope="col"><input type="text" id="cf_date" placeholder="Dátumok kiválasztása" placeholder="Időpont" style="border: solid 1px;min-width: 200px;"></th> --}}
                    {{-- <th scope="col">Befejezés</th> --}}
                    {{-- <th scope="col">Név</th> --}}
...
@push('scripts')
    ...
    <script type="text/javascript" src="/adminset/js/custom/booking_list.js?{{ time() }}"></script>
@endpush