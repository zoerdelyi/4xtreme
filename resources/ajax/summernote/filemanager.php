<div class="modal-dialog modal-lg" style="overflow:initial">
    <div class="modal-content">
        <div class="btn-default modal-header" style="padding-bottom: 10px;">
            <h5 class="modal-title"><i class="fa fa-image"></i>&nbsp;&nbsp;Kép rendszerező</h5>
            <div class="ml-auto">
        ...
        <?php
        $site_url = '/images/'; //edit path
        $directory = "../../../images/"; //edit path
        ...
        <script>
            ...
            function load_folders_images(current_dir) {
                $.ajax({
                    url: "/adminset/ajax/summernote/load_folders_images.php",
                    type: "POST",
                    data: {
        ...
        <div id="modal-folders-images">
            <?php
            require('load_folders_images.php');
            ?>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p id="imagepreview_name" style="float: left; margin-bottom: 0;"></p>
